...
const CSV_URLS = {
    ...
    software: `${BASE_PATH}05_informacion_proyectos/Software_portafolio.csv?t=${timestamp}`,
    ...
    proyectos_global: `${BASE_PATH}05_informacion_proyectos/Proyectos_portafolio.csv?t=${timestamp}`,
    disciplinas_global: `${BASE_PATH}05_informacion_proyectos/Disciplinas_portafolio.csv?t=${timestamp}`,
    normas: `${BASE_PATH}05_informacion_proyectos/Normativas%20y%20Est%C3%A1ndares_portafolio.csv?t=${timestamp}`,
    summary: `${BASE_PATH}05_informacion_proyectos/Resumen_portafolio.csv?t=${timestamp}`
};
        ...
        sortedCerts.forEach((cert, idx) => {
            ...
            if (badgeFile) {
                ...
                if (normalizeStr(nombre).includes('master') || normalizeStr(nombre).includes('superior')) {
                    ...
                    finalBadgeSrc = "https://raw.githubusercontent.com/eduardoehr89-source/portafolio/main/01_Sitio_Web/CV/Insignias/04_BIM%20Boot%20Camp_badge_2.png";
                }
...
function initPrintLogic() {
    ...
    window.confirmPrint = () => {
        ...
        if (frontImg) {
            ...
            frontImg.src = 'https://raw.githubusercontent.com/eduardoehr89-source/portafolio/main/01_Sitio_Web/CV/Fotos%20de%20perfil/profile_optimized_01.jpg';
            frontImg.style.opacity = '1';
        }
