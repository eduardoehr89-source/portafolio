...
* 1.4.1. **Proporción:** Visual horizontal expansiva (4:3 o 5:3 según texto).
* 1.4.2. **Ancho Fijo:** Estándar inamovible de **650px**.
* 1.4.3. **Alineación:** Contenido estrictamente CENTRADO y alineado arriba.
...
* 1.4.6. **Cero Scroll:** Prohibido ocultar texto. El área debe crecer para mostrar todo el contenido.
* 1.4.7. **Margen Estético:** Padding interno reducido de **24px (p-6)** para una relación texto-caja óptima.
